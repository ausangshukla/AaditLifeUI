...
# password is connuct
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore AaditLife.keystore /home/thimmaiah/work/angular/AaditLifeUI/platforms/android/build/outputs/apk/android-release-unsigned.apk Connuct
